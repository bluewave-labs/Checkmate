...
class MonitorController extends BaseController {
	...
	bulkToggleActive = this.asyncHandler(
		async (req, res) => {
			await bulkToggleActiveBodyValidation.validateAsync(req.body);
			...
			await this.monitorService.bulkToggleActive({ teamId, monitorIds, isActive });
	...
	bulkDelete = this.asyncHandler(
		async (req, res) => {
			await bulkDeleteBodyValidation.validateAsync(req.body);
			...
			await this.monitorService.bulkDelete({ teamId, monitorIds });
	...
	bulkUpdateNotifications = this.asyncHandler(
		async (req, res) => {
			await bulkUpdateNotificationsBodyValidation.validateAsync(req.body);
			...
			await this.monitorService.bulkUpdateNotifications({
				teamId,
				monitorIds,
