...
class MonitorController {
	...
	bulkToggleActive = async (req: Request, res: Response, next: NextFunction) => {
		try {
			...
			await this.monitorService.bulkToggleActive(monitorIds, isActive, tokenizedUser);
	...
	bulkUpdateNotifications = async (req: Request, res: Response, next: NextFunction) => {
		try {
			...
			await this.monitorService.bulkUpdateNotifications(monitorIds, notificationChannels, tokenizedUser);
