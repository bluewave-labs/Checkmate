					...
					groupedChecks: [
						{
							$group: {
								...
								avgResponseTime: { $avg: "$responseTime" },
								avgDns: { $avg: "$timings.phases.dns" },
								avgTcp: { $avg: "$timings.phases.tcp" },
								avgTls: { $avg: "$timings.phases.tls" },
								avgRequest: { $avg: "$timings.phases.request" },
								avgFirstByte: { $avg: "$timings.phases.firstByte" },
								avgDownload: { $avg: "$timings.phases.download" },
								totalChecks: { $sum: 1 },
							},
						},
						{ $sort: { _id: 1 } },
						{
							$project: {
								...
								avgResponseTime: 1,
								totalChecks: 1,
								avgDns: { $ifNull: ["$avgDns", 0] },
								avgTcp: { $ifNull: ["$avgTcp", 0] },
								avgTls: { $ifNull: ["$avgTls", 0] },
								avgRequest: { $ifNull: ["$avgRequest", 0] },
								avgFirstByte: { $ifNull: ["$avgFirstByte", 0] },
								avgDownload: { $ifNull: ["$avgDownload", 0] },
								_id: 0,
							},
						},
					],
