...
export const createMonitorBodyValidation = z.object({
	...
	escalateAfterMinutes: z.number().min(1, "Escalation delay must be at least 1 minute").optional(),
	escalationNotificationChannels: z.string().optional(),
...
const importedMonitorSchema = z.object({
	...
	escalateAfterMinutes: z.number().min(1, "Escalation delay must be at least 1 minute").optional(),
	escalationNotificationChannels: z.string().default(""),
	downSince: z.string().optional(),
	secret: z.string().optional(),
