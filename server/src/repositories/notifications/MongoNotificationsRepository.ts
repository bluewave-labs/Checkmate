...
class MongoNotificationsRepository implements INotificationsRepository {
	...
	private toEntity = (doc: NotificationDocument): Notification => {
		...
		return {
			...
			webhookAuthType: doc.webhookAuthType ?? undefined,
			webhookAuthUsername: doc.webhookAuthUsername ?? undefined,
			webhookAuthPassword: doc.webhookAuthPassword ?? undefined,
			webhookAuthToken: doc.webhookAuthToken ?? undefined,
