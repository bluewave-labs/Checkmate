...
export const setupRoutes = (app: Application, controllers: InitializedControllers, services: InitializedServices) => {
	...
	const verifyStatusPageAccess = createVerifyStatusPageAccess(services.statusPagesRepository, verifyJWT, services.settingsService);
	const statusPageRoutes = new StatusPageRoutes(controllers.statusPageController, verifyJWT, verifyStatusPageAccess, authApiLimiter);
