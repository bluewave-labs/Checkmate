...
import ScriptController from "../api/controllers/scriptController.js";
import CaptureAgentController from "../api/controllers/captureAgentController.js";
...
export const initializeControllers = (apiServices: ApiServices): InitializedControllers => {
	return {
		...
		scriptController: new ScriptController(apiServices.scriptService),
		captureAgentController: new CaptureAgentController(apiServices.captureAgentService),
	};
};
