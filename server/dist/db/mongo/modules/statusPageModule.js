    ...
    getStatusPage = async (url) => {
        try {
            ...
            if (!preliminaryStatusPage.monitors || preliminaryStatusPage.monitors.length === 0) {
                const { _id, color, companyName, isPublished, logo, originalMonitors, showCharts, showUptimePercentage, timezone, showAdminLoginLink, url } = preliminaryStatusPage;
                return {
                    statusPage: {
                        _id,
                        color,
...
//# sourceMappingURL=statusPageModule.js.map