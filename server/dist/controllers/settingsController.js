...
class SettingsController extends BaseController {
    ...
    getAppSettings = this.asyncHandler(async (req, res) => {
    ...
    }, SERVICE_NAME, "getAppSettings");
    updateAppSettings = this.asyncHandler(async (req, res) => {
    ...
    }, SERVICE_NAME, "updateAppSettings");
    sendTestEmail = this.asyncHandler(async (req, res) => {
        await sendTestEmailBodyValidation.validateAsync(req.body);
        const { to, systemEmailHost, systemEmailPort, systemEmailAddress, systemEmailPassword, systemEmailUser, systemEmailConnectionHost, systemEmailSecure, systemEmailPool, systemEmailIgnoreTLS, systemEmailRequireTLS, systemEmailRejectUnauthorized, systemEmailTLSServername, } = req.body;
