...
class InviteController extends BaseController {
     ...
     */
    getInviteToken = this.asyncHandler(async (req, res) => {
     ...
     * @returns {Promise<Object>} Response with invite token data
     */
    sendInviteEmail = this.asyncHandler(async (req, res) => {
     ...
     */
    verifyInviteToken = this.asyncHandler(async (req, res) => {
    ...
    }, SERVICE_NAME, "verifyInviteToken");
}
