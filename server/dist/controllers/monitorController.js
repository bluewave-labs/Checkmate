...
class MonitorController extends BaseController {
    ...
    getAllMonitors = this.asyncHandler(async (req, res) => {
        const monitors = await this.monitorService.getAllMonitors();
        return res.success({
            msg: this.stringService.monitorGetAll,
            data: monitors,
        });
    }, SERVICE_NAME, "getAllMonitors");
    getUptimeDetailsById = this.asyncHandler(async (req, res) => {
    ...
    }, SERVICE_NAME, "getUptimeDetailsById");
    getMonitorStatsById = this.asyncHandler(async (req, res) => {
    ...
    }, SERVICE_NAME, "getMonitorStatsById");
    /**
     ...
     */
    getHardwareDetailsById = this.asyncHandler(async (req, res) => {
    ...
    getMonitorCertificate = this.asyncHandler(async (req, res) => {
    ...
    getMonitorById = this.asyncHandler(async (req, res) => {
    ...
    }, SERVICE_NAME, "getMonitorById");
    createMonitor = this.asyncHandler(async (req, res) => {
    ...
    }, SERVICE_NAME, "createMonitor");
    createBulkMonitors = this.asyncHandler(async (req, res) => {
        if (!req.file) {
    ...
    }, SERVICE_NAME, "createBulkMonitors");
    deleteMonitor = this.asyncHandler(async (req, res) => {
        await getMonitorByIdParamValidation.validateAsync(req.params);
        const monitorId = req.params.monitorId;
        const teamId = req?.user?.teamId;
        if (!teamId) {
    ...
    }, SERVICE_NAME, "deleteMonitor");
    deleteAllMonitors = this.asyncHandler(async (req, res) => {
        const teamId = req?.user?.teamId;
        if (!teamId) {
            throw this.errorService.createBadRequestError("Team ID is required");
        }
    ...
    }, SERVICE_NAME, "deleteAllMonitors");
    editMonitor = this.asyncHandler(async (req, res) => {
        await getMonitorByIdParamValidation.validateAsync(req.params);
    ...
    }, SERVICE_NAME, "editMonitor");
    pauseMonitor = this.asyncHandler(async (req, res) => {
    ...
    }, SERVICE_NAME, "pauseMonitor");
    addDemoMonitors = this.asyncHandler(async (req, res) => {
    ...
    }, SERVICE_NAME, "sendTestEmail");
    getMonitorsByTeamId = this.asyncHandler(async (req, res) => {
    ...
    getMonitorsAndSummaryByTeamId = this.asyncHandler(async (req, res) => {
        await getMonitorsByTeamIdParamValidation.validateAsync(req.params);
        await getMonitorsByTeamIdQueryValidation.validateAsync(req.query);
    ...
    getMonitorsWithChecksByTeamId = this.asyncHandler(async (req, res) => {
        await getMonitorsByTeamIdParamValidation.validateAsync(req.params);
        await getMonitorsByTeamIdQueryValidation.validateAsync(req.query);
        const explain = req?.query?.explain;
        let { limit, type, page, rowsPerPage, filter, field, order } = req.query;
    ...
    }, SERVICE_NAME, "getMonitorsWithChecksByTeamId");
    exportMonitorsToCSV = this.asyncHandler(async (req, res) => {
        const teamId = req?.user?.teamId;
        if (!teamId) {
            throw this.errorService.createBadRequestError("Team ID is required");
        }
    ...
    }, SERVICE_NAME, "exportMonitorsToCSV");
    getAllGames = this.asyncHandler(async (req, res) => {
        return res.success({
            msg: "OK",
