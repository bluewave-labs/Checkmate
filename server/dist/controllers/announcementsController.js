...
class AnnouncementController extends BaseController {
     ...
     */
    createAnnouncement = asyncHandler(async (req, res, next) => {
    ...
    }, SERVICE_NAME, "createAnnouncement");
    /**
