...
class StatusPageController extends BaseController {
    ...
    createStatusPage = this.asyncHandler(async (req, res) => {
    ...
    }, SERVICE_NAME, "createStatusPage");
    updateStatusPage = this.asyncHandler(async (req, res) => {
        await createStatusPageBodyValidation.validateAsync(req.body);
        await imageValidation.validateAsync(req.file);
    ...
    }, SERVICE_NAME, "updateStatusPage");
    getStatusPage = this.asyncHandler(async (req, res) => {
        const statusPage = await this.db.statusPageModule.getStatusPage();
        return res.success({
            msg: this.stringService.statusPageByUrl,
            data: statusPage,
        });
    }, SERVICE_NAME, "getStatusPage");
    getStatusPageByUrl = this.asyncHandler(async (req, res) => {
    ...
    getStatusPagesByTeamId = this.asyncHandler(async (req, res) => {
    ...
    }, SERVICE_NAME, "getStatusPagesByTeamId");
    deleteStatusPage = this.asyncHandler(async (req, res) => {
        await this.db.statusPageModule.deleteStatusPage(req.params.url);
        return res.success({
            msg: this.stringService.statusPageDelete,
        });
    }, SERVICE_NAME, "deleteStatusPage");
}
