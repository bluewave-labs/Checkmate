...
import { registrationBodyValidation, loginValidation, editUserBodyValidation, recoveryValidation, recoveryTokenBodyValidation, newPasswordValidation, getUserByIdParamValidation, editUserByIdParamValidation, editUserByIdBodyValidation, editSuperadminUserByIdBodyValidation, } from "../validation/joi.js";
...
class AuthController extends BaseController {
     ...
     * }
     */
    editUser = this.asyncHandler(async (req, res) => {
     ...
     */
    checkSuperadminExists = this.asyncHandler(async (req, res) => {
    ...
    }, SERVICE_NAME, "checkSuperadminExists");
    /**
     ...
     * }
     */
    requestRecovery = this.asyncHandler(async (req, res) => {
     ...
     * }
     */
    validateRecovery = this.asyncHandler(async (req, res) => {
     ...
     * // Requires JWT authentication with superadmin role
     */
    editUserById = this.asyncHandler(async (req, res) => {
        const roles = req?.user?.role;
