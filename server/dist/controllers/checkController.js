...
import { getChecksParamValidation, getChecksQueryValidation, getTeamChecksQueryValidation, deleteChecksParamValidation, deleteChecksByTeamIdParamValidation, updateChecksTTLBodyValidation, ackCheckBodyValidation, ackAllChecksParamValidation, ackAllChecksBodyValidation, } from "../validation/joi.js";
...
class CheckController extends BaseController {
     ...
     */
    getChecksByMonitor = this.asyncHandler(async (req, res) => {
    ...
    }, SERVICE_NAME, "getChecksByMonitor");
    /**
     ...
     * // Requires JWT authentication
     */
    getChecksByTeam = this.asyncHandler(async (req, res) => {
     ...
     */
    getChecksSummaryByTeamId = this.asyncHandler(async (req, res) => {
    ...
    }, SERVICE_NAME, "getChecksSummaryByTeamId");
    /**
     ...
     * // Requires JWT authentication
     */
    ackCheck = this.asyncHandler(async (req, res) => {
     ...
     * // Requires JWT authentication
     */
    ackAllChecks = this.asyncHandler(async (req, res) => {
     ...
     */
    deleteChecks = this.asyncHandler(async (req, res) => {
     ...
     */
    deleteChecksByTeamId = this.asyncHandler(async (req, res) => {
    ...
    }, SERVICE_NAME, "deleteChecksByTeamId");
    /**
     ...
     */
    updateChecksTTL = this.asyncHandler(async (req, res) => {
