...
class MaintenanceWindowController extends BaseController {
    ...
    createMaintenanceWindows = this.asyncHandler(async (req, res) => {
    ...
    }, SERVICE_NAME, "createMaintenanceWindows");
    getMaintenanceWindowById = this.asyncHandler(async (req, res) => {
    ...
    }, SERVICE_NAME, "getMaintenanceWindowById");
    getMaintenanceWindowsByTeamId = this.asyncHandler(async (req, res) => {
    ...
    }, SERVICE_NAME, "getMaintenanceWindowsByTeamId");
    getMaintenanceWindowsByMonitorId = this.asyncHandler(async (req, res) => {
    ...
    deleteMaintenanceWindow = this.asyncHandler(async (req, res) => {
    ...
    }, SERVICE_NAME, "deleteMaintenanceWindow");
    editMaintenanceWindow = this.asyncHandler(async (req, res) => {
    ...
    }, SERVICE_NAME, "editMaintenanceWindow");
}
export default MaintenanceWindowController;
//# sourceMappingURL=maintenanceWindowController.js.map