...
import { MIN_INVITE_DURATION_HOURS, MAX_INVITE_DURATION_HOURS } from "@/Utils/inviteDurationOptions";
...
export const inviteSchema = z.object({
	...
	expiresInHours: z
		...
		.max(MAX_INVITE_DURATION_HOURS, "Please select how long the invite should stay valid"),
});
