...
set dockerfiles[0]=.\docker\staging\client.Dockerfile

set services[1]=uptime_database_mongo
set dockerfiles[1]=.\docker\staging\mongoDB.Dockerfile

set services[2]=uptime_server
set dockerfiles[2]=.\docker\staging\server.Dockerfile
