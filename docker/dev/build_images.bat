...
set dockerfiles[0]=.\docker\dev\client.Dockerfile

set services[1]=uptime_mongo
set dockerfiles[1]=.\docker\dev\mongoDB.Dockerfile

set services[2]=uptime_server
set dockerfiles[2]=.\docker\dev\server.Dockerfile
